                ...
                <div class="QuestionArea" style="border: 0px solid; float: left;">
                    ...
                    <div class="SelectionArea">
                        ...
                        <div class="SelectionQuestion SelectionQuestionMargins">
                            ...
                            <div style="float: left;">
                                <select class="dd borderRadius Month" data-bind="event: { change: CheckSubmitDisable }">
                                    <asp:Literal ID="ltMonths" runat="server"></asp:Literal>
                                </select>
                            </div>
                            <div style="float: left;">
                                <select class="dd borderRadius Day" data-bind="event: { change: CheckSubmitDisable }">
                                    <asp:Literal ID="ltDays" runat="server"></asp:Literal>
                                </select>
                            </div>
                            <div style="float: left;">
                                <select class="dd borderRadius Year" data-bind="event: { change: CheckSubmitDisable }">
                    ...
                    <div class="SelectionArea">
                        ...
                        <div class="SelectionQuestion SelectionQuestionMargins">
                            ...
                            <div style="float: left;">
                                <select class="dd borderRadius SelectOptionsOne" data-bind="event: { change: CheckSubmitDisable }">
                            ...
                            <div style="float: left;">
                                <select class="dd borderRadius SelectOptionsTwo" data-bind="event: { change: CheckSubmitDisable }">
