...
namespace IntelliWebR1.web.inner
{
    public partial class profilecriteria : System.Web.UI.Page
    {
        ...
        protected void dgOtherUserCriteriaTable_ItemDataBound(object sender, DataGridItemEventArgs e)
        {
            ...
            {
                e.Item.Cells[3].Text = "";
                if (e.Item.Cells[4].Text.ToLower().IndexOf("points earned") != -1)
                {
                ...
                if (e.Item.Cells[1].Text.ToLower().IndexOf("Their Preference") != -1 || e.Item.Cells[2].Text.ToLower().IndexOf("my answer(s)") != -1)
                {
