    ...
    public partial class profilequestions : System.Web.UI.Page
    {
        ...
        private void LoadScripts(bool loadPhilosophy, int OtherUserID, int SelectedItem)
        {
           ...
           _Scripts = _Scripts + "\n<script type=\"text/javascript\">var _SelectedItem=\"" + SelectedItem.ToString() + "\"</script>";
            ...
            ////    _Scripts = _Scripts + "\n" + "<script src=\"" + SitePath + "Scripts/jsMessages\" type=\"text/javascript\"></script>";
            ////     _Scripts = _Scripts + "\n" + "<script src=\"" + SitePath + "Scripts/jquery.timeago.js\" type=\"text/javascript\"></script>";
            ////   _Scripts = _Scripts + "\n" + "<script src=\"" + SitePath + "Scripts/js_fun.min.js\" type=\"text/javascript\"></script>";
            ////  _Scripts = _Scripts + "\n<script type=\"text/javascript\" src=\"" + SitePath + "web/js/jquery.colorbox.js\"></script>";
            ////  _Scripts = _Scripts + "\n<script type=\"text/javascript\" src=\"" + SitePath + "web/js/jquery.confirm.min.js\"></script>";

            ////   _Scripts = _Scripts + "\n<script type=\"text/javascript\" src=\"" + SitePath + "web/js/ekScrollable.js\"></script>";
            ////   _Scripts = _Scripts + "\n<script type=\"text/javascript\" src=\"" + SitePath + "web/js/jquery.mousewheel.js\"></script>";



            ////  _Scripts = _Scripts + "\n<link href=\"" + SitePath + "web/css/colorbox.css\" rel=\"stylesheet\" />";
            //// _Scripts = _Scripts + "\n<link href=\"" + SitePath + "web/css/intellidate.css\" rel=\"stylesheet\" />";
            ////  _Scripts = _Scripts + "\n<link href=\"" + SitePath + "web/css/styles.css\" rel=\"stylesheet\" />";

            //if (loadPhilosophy)
            //    _Scripts = _Scripts + "\n<script type=\"text/javascript\" src=\"" + SitePath + "web/js/js_philosophy.js\"></script>";
