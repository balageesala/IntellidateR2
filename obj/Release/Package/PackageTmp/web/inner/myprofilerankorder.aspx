<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="myprofilerankorder.aspx.cs" Inherits="IntellidateR1Web.web.inner.myprofilerankorder" %>
...
<div id="divRankOrder" data-bind="template: { name: 'template_rankorder', foreach: AllAnswers }"></div>
...
<script type="text/html" id="template_rankorder">
    ...
    <div class="rank-title" data-bind="text: QuestionDetails().QuestionText"></div>
</script>
