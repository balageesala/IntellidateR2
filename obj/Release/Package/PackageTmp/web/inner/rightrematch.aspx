<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="rightrematch.aspx.cs" Inherits="IntellidateR1Web.web.inner.rightrematch" %>
<asp:Literal ID="ltScripts" runat="server"></asp:Literal>
<div class="divpassport" style="border:0px;">
     <div class="divuname" id="divUserName" runat="server" style="float:right;margin-right:10px;"></div>
