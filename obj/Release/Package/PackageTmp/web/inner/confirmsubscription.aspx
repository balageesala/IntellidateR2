<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="confirmsubscription.aspx.cs" Inherits="IntellidateR1Web.web.inner.confirmsubscription" %>
    ...
    <div style="width: 600px; min-height: 310px; border: 0px solid #ccc; margin: 0 auto; font-family: Arial; border-radius: 2px 4px;" id="divCanSend" runat="server" visible="true">
        ...
        <script type="text/javascript">
            $(document).ready(function () {
                ...
                var _Mounths = getParameterByName("mounth");
                if (_SubType == "1") {
                    $("#divTop").show();
                    $("#divBasic").hide();
                ...
                $("#divNoOfMounths").html("No of subscription mounths: " + _Mounths);
