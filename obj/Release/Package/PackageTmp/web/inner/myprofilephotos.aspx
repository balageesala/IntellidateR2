<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="myprofilephotos.aspx.cs" Inherits="IntellidateR1Web.web.inner.myprofilephotos" %>
    ...
    <div style="float: left;margin-left:4px;">
        ...
        <div data-bind="event: { mouseover: helpers.onMouseOver, mouseleave: helpers.onMouseLeave }">
            <div style="margin: 2px;border:1px solid #ccc;">
                <img data-bind="attr: { src: PhotoPath, 'data-url': PhotoFullView, 'data-width': PopupWidth, 'data-height': PopupHeight, 'data-pos':  Position }" style="width: 180px;min-height:120px; cursor: pointer;" class="photoThumb" />   
                <div style="color: #000;font-size:10px;text-align:center;width: 180px; " data-bind="text:ReviewText "> </div>
